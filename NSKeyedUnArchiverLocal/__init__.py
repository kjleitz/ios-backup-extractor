...
#
# This file is part of ios-backup-extractor.
# Originally from NSKeyedUnArchiver by Avi Alkalay.
...
def _unserialize(o: dict, serialized: dict, removeClassName: bool, simplify: bool, start: bool=True):
    ...
    while not finished:
        ...
        if isinstance(reassembled,bytes):
            ...
            module_logger.debug("reassembled is a %s: %r", type(reassembled), reassembled)
            return reassembled
